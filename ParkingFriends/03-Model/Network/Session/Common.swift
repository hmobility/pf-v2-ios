...
class Common : HttpSession {
    ...
    static public func cars_brands() -> Observable<(CarBrands?, ResponseCodeType)>  {
    ...
    static public func cars_brands_models(brandId:Int) -> Observable<(CarModels?, ResponseCodeType)>  {
