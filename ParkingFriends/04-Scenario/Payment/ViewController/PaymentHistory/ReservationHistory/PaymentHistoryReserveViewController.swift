...
class PaymentHistoryReserveViewController: UIViewController {
   ...
   // private var dataSource: RxTableViewSectionedReloadDataSource<OrdersElement>!
    ...
    private func setupOrderHistoryBinding() {
        historyItems
            .asObservable()
            .bind(to: tableView.rx.items(cellIdentifier: "PaymentHistoryReserveTableViewCell", cellType: PaymentHistoryReserveTableViewCell.self)) { row , item, cell in
